...
end1
cat about-us-screen.pug >> newFile.pug
mv -f newFile.pug  about-us-screen.pug
...
end3
cat about-us-screen.scss >> newFile.scss
mv -f newFile.scss about-us-screen.scss
cd ${fileName}
