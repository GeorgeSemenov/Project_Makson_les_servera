#!/bin/sh
parentName=collaboration-stages-screen
...
end1
cat collaboration-stages-screen.pug >> newFile.pug
mv -f newFile.pug  collaboration-stages-screen.pug
...
end3
cat collaboration-stages-screen.scss >> newFile.scss
mv -f newFile.scss collaboration-stages-screen.scss
cd ${fileName}
