...
end1
cat cooperation-screen.pug >> newFile.pug
mv -f newFile.pug  cooperation-screen.pug
...
end3
cat cooperation-screen.scss >> newFile.scss
mv -f newFile.scss cooperation-screen.scss
cd ${fileName}
