...
end1
cat advantage-card.pug >> newFile.pug
mv -f newFile.pug  advantage-card.pug
...
end3
cat advantage-card.scss >> newFile.scss
mv -f newFile.scss advantage-card.scss
cd ${fileName}
