...
end1
cat advantages-screen.pug >> newFile.pug
mv -f newFile.pug  advantages-screen.pug
...
end3
cat advantages-screen.scss >> newFile.scss
mv -f newFile.scss advantages-screen.scss
cd ${fileName}
