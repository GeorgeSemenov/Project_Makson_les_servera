...
end1
cat prices-screen.pug >> newFile.pug
mv -f newFile.pug  prices-screen.pug
...
end3
cat prices-screen.scss >> newFile.scss
mv -f newFile.scss prices-screen.scss
cd ${fileName}
